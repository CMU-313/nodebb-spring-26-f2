...
async function toggleBookmark(Posts, {type, pid, uid}) {
...
module.exports = function (Posts) {
	Posts.bookmark = async function (pid, uid) {
		return await toggleBookmark(Posts, {type: 'bookmark', pid, uid});
	};

	Posts.unbookmark = async function (pid, uid) {
		return await toggleBookmark(Posts, {type: 'unbookmark', pid, uid});
	};
